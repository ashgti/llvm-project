...
//   json::Object Result{{"jsonrpc", "2.0"}, {"id", R.id}, {"method",
//   R.method}}; if (R.params)
...
// bool fromJSON(const llvm::json::Value &V, Notification &N, llvm::json::Path
// P) {
//   llvm::json::ObjectMapper O(V, P);
...
// bool fromJSON(const llvm::json::Value &V, Capabilities &C, llvm::json::Path
// P) {
//   llvm::json::ObjectMapper O(V, P);
...
// bool fromJSON(const llvm::json::Value &V, TextContent &TC, llvm::json::Path
// P) {
//   llvm::json::ObjectMapper O(V, P);
...
//   return llvm::json::Object{{"content", TR.content}, {"isError",
//   TR.isError}};
// }
